...
Полу-игровая развлекательная механика, которая подразумевает наличие какого-то количества фракций и "борьбу" за очки. Очки выдаются за активность в чате, выдачу и получение отзывов, сбор рейда, отклик на рейды и так далее. По истечении какого-то срока, будет выводиться список трёх самых активных игроков во фракциях. Администрация сможет проводить конкурсы и собирать статистику благодаря этой системе.

### 3. Рандомайзер ###

Простая полу-игровая система, которая подразумевает наличие команд "для рандомизации" в зависимости от заданных параметров. Аналог бросков кубика, монетки и так далее. Цель - решение споров или просто развлекательный контент.

### 4. Кодекс ###

Под кодексом подразумевается хранение информации. Мы должны вызвать команду, задать ей необходимую категорию (прим. рейды, билды и т.д.), задать необходимое название для информации (прим. гайд Камен 2.0),
указать урл, откуда была взята информация (если возможно указать, например, лоаву или нексус) и сохранять текст и изображения, которые пользователь предоставит.
Искать информацию мы сможем по категории, нажимая на кнопки под сообщением, и после по названию, так же, используя кнопки. 
Должны предусмотреть возможность изменения \ обновления информации и её источников, а так же указывать язык предоставляемой информации.
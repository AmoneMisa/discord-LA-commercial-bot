...
Под кодексом подразумевается хранение информации. Мы должны вызвать команду, задать ей категорию (прим. рейды, билды и т.д.), название для информации (прим. гайд Камен 2.0),
урл, откуда была взята информация (если возможно указать, например, лоаву или нексус) и сохранять текст и изображения, которые пользователь предоставит.
